...
- chapter_format: gunakan template dengan placeholder {n} (contoh: "BAB {n}")
- sub_chapter_format: gunakan template dengan placeholder {bab} dan {sub} (contoh: "{bab}.{sub}")
- figure_format: gunakan template dengan placeholder {n} (contoh: "Gambar {n}.")
- table_format: gunakan template (contoh: "Tabel {bab}.{n}")
