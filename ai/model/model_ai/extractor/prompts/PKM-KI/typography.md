...
- Ditemukan "BAB 1. PENDAHULUAN", "BAB 3. TAHAP PELAKSANAAN" (huruf kapital semua) → `heading_all_caps = true`
- Ditemukan "BAB 1. Pendahuluan", "BAB 3. Tahap Pelaksanaan" (Title Case) → `heading_all_caps = false`
