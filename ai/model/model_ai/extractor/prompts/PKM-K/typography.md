...
- Ditemukan "BAB 1. PENDAHULUAN", "BAB 2. GAMBARAN UMUM RENCANA USAHA" (huruf kapital semua) → `heading_all_caps = true`
- Ditemukan "BAB 1. Pendahuluan", "BAB 2. Gambaran Umum Rencana Usaha" (Title Case) → `heading_all_caps = false`
