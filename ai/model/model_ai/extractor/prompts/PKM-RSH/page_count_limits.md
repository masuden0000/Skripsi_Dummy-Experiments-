---
queries:
  - "maksimum halaman inti batas halaman proposal PKM-RSH ketentuan umum"
  - "jumlah halaman maksimum proposal PKM riset sosial humaniora lampiran tidak dihitung"
  - "batas maksimum halaman bagian inti dari BAB sampai Daftar Pustaka RSH"
  - "halaman inti dimulai BAB Pendahuluan berakhir Daftar Pustaka proposal RSH"
section_focus:
  - "SISTEMATIKA PENULISAN PROPOSAL"
  - "SISTEMATIKA PROPOSAL KEGIATAN"
---

# Tugas Ekstraksi: Batas Halaman Proposal PKM-RSH

## Konteks
{context}

## Tugas
Ekstrak batas maksimum halaman inti untuk **proposal PKM-RSH** (Riset Sosial Humaniora) dari konteks di atas.
...
Ambil HANYA nilai untuk "proposal PKM-RSH" — abaikan baris/kalimat untuk laporan kemajuan atau laporan akhir.
Contoh penalaran: *"Saya menemukan tabel dengan baris 'Proposal PKM-RSH: 10 halaman' → proposal_halaman_inti_maks = 10."*
