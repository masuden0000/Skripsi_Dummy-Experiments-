...
- Ditemukan "BAB 1. PENDAHULUAN", "BAB 2. GAMBARAN UMUM MASYARAKAT MITRA" (huruf kapital semua) → `heading_all_caps = true`
- Ditemukan "BAB 1. Pendahuluan", "BAB 2. Gambaran Umum Masyarakat Mitra" (Title Case) → `heading_all_caps = false`
